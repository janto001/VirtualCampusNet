/**
 * Filename: ValidationFlowDetails.java
 *
...
@Setter
@Entity
@Table(name = "validation_flow_details")
public class ValidationFlowDetails {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "validation_id")
	private int validationId;

	@Column(name = "validator_flow_name", length = 100, nullable = false)
	private String validatorFlowName;

	@Column(name = "bean_name", length = 200, nullable = false)
