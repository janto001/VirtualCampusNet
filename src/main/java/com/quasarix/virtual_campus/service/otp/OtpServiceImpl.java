/**
 * Filename: OtpServiceImplementation.java © Copyright 2023 Quasarix. ALL RIGHTS RESERVED. All rights, title and interest (including all intellectual
...
public class OtpServiceImpl implements OtpService {
	...
	public boolean validateOTP(String key, String otp) {
		String intToStringOtp = Integer.toString(getOtp(key));
		if (otp.equals(intToStringOtp)) {
			log.debug("OTP is verified | userName:{} " + key);
			return true;
		}
		else {
			log.debug("OTP is invalid | userName:{} " + key);
			return false;
		}
	}
